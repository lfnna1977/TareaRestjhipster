...
public class ClubResourceIT {
    ...
    private static final Integer DEFAULT_NUM_SOCIOS = 1;
    private static final Integer UPDATED_NUM_SOCIOS = 2;
    ...
    public void createClub() throws Exception {
        ...
        assertThat(testClub.getNumSocios()).isEqualTo(DEFAULT_NUM_SOCIOS);
    }
    ...
    public void getAllClubs() throws Exception {
        ...
        restClubMockMvc.perform(get("/api/clubs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numSocios").value(hasItem(DEFAULT_NUM_SOCIOS)));
    }
    ...
    public void getClub() throws Exception {
        ...
        restClubMockMvc.perform(get("/api/clubs/{id}", club.getId()))
            ...
            .andExpect(jsonPath("$.numSocios").value(DEFAULT_NUM_SOCIOS));
    }
    ...
    public void updateClub() throws Exception {
        ...
        assertThat(testClub.getNumSocios()).isEqualTo(UPDATED_NUM_SOCIOS);
    }
