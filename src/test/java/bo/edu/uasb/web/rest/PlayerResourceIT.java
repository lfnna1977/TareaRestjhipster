...
public class PlayerResourceIT {
    ...
    private static final String DEFAULT_ADITIONAL_DATA = "AAAAAAAAAA";
    private static final String UPDATED_ADITIONAL_DATA = "BBBBBBBBBB";
    ...
    public static Player createEntity(EntityManager em) {
        Player player = new Player()
            ...
            .aditionalData(DEFAULT_ADITIONAL_DATA);
        // Add required entity
        Country country;
    ...
    public static Player createUpdatedEntity(EntityManager em) {
        Player player = new Player()
            ...
            .aditionalData(UPDATED_ADITIONAL_DATA);
        // Add required entity
        Country country;
        if (TestUtil.findAll(em, Country.class).isEmpty()) {
    ...
    public void createPlayer() throws Exception {
        ...
        assertThat(testPlayer.getCi()).isEqualTo(DEFAULT_CI);
        ...
        assertThat(testPlayer.getAditionalData()).isEqualTo(DEFAULT_ADITIONAL_DATA);
    }
    ...
    @Test
    @Transactional
    public void checkCiIsRequired() throws Exception {
    ...
    public void getAllPlayers() throws Exception {
        ...
        restPlayerMockMvc.perform(get("/api/players?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].aditionalData").value(hasItem(DEFAULT_ADITIONAL_DATA.toString())));
    }
    ...
    public void getPlayer() throws Exception {
        ...
        restPlayerMockMvc.perform(get("/api/players/{id}", player.getId()))
            ...
            .andExpect(jsonPath("$.aditionalData").value(DEFAULT_ADITIONAL_DATA.toString()));
    }
    ...
    public void updatePlayer() throws Exception {
        ...
        Player testPlayer = playerList.get(playerList.size() - 1);
        assertThat(testPlayer.getCi()).isEqualTo(UPDATED_CI);
        ...
        assertThat(testPlayer.getAditionalData()).isEqualTo(UPDATED_ADITIONAL_DATA);
    }
